                    ...
                    while ($res = mysqli_fetch_array($query))
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <div class="btn-group" role="group" aria-label="Basic example" style="position: relative; display: flex; vertical-align: middle;"> 
                                <button class="btn-danger btn btn-sm"> <a href="edit.php?id=<?php echo $res['id']; ?>" class="text-white">Edit</a> </button>

                                  <button class="btn-danger btn btn-sm"> <a href="databasedelete.php?id=<?php echo $res['id']; ?>" class="text-white">Delete</a> </button> 
                              </div>
                            </td>
                          </tr>
                        <?php 
